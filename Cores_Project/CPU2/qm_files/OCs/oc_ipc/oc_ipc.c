//$file${.::Cores_Project::CPU2::qm_files::OCs::oc_ipc::oc_ipc.c} vvvvvvvvvvvv
//
// Model: main_model.qm
// File:  ${.::Cores_Project::CPU2::qm_files::OCs::oc_ipc::oc_ipc.c}
//
...
//
//$endhead${.::Cores_Project::CPU2::qm_files::OCs::oc_ipc::oc_ipc.c} ^^^^^^^^^
#include "./oc_ipc.h"
