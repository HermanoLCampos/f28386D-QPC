//$file${.::Cores_Project::CPU2::qm_files::macros_qm.h} vvvvvvvvvvvvvvvvvvvvvv
//
// Model: main_model.qm
// File:  ${.::Cores_Project::CPU2::qm_files::macros_qm.h}
//
...
//
//$endhead${.::Cores_Project::CPU2::qm_files::macros_qm.h} ^^^^^^^^^^^^^^^^^^^
