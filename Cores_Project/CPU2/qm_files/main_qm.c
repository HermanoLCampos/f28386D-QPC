//$file${.::Cores_Project::CPU2::qm_files::main_qm.c} vvvvvvvvvvvvvvvvvvvvvvvv
//
// Model: main_model.qm
// File:  ${.::Cores_Project::CPU2::qm_files::main_qm.c}
//
...
//
//$endhead${.::Cores_Project::CPU2::qm_files::main_qm.c} ^^^^^^^^^^^^^^^^^^^^^
#include "main_qm.h"
...
com_tag_t com_signals_ipc_cpu1_cpu2[COM_SIG_IPC_CPU1_CPU2_MAX] ={
};

//${CPU2::Signals::com_signals_ipc_cm_cpu2[COM_SIG_~} ........................
com_tag_t com_signals_ipc_cm_cpu2[COM_SIG_IPC_CM_CPU2_MAX] ={
};
//$enddef${CPU2::Signals} ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
