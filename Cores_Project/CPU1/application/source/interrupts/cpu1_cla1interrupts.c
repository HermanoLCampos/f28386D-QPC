...
#define HALL1_CURRENT_LOW_LIMIT_CHECK      ((uint16_t)(HALL1_CURRENT_BIT_OFFSET-CRITICAL_LIMIT_HALL_CURRENT/HALL1_CURRENT_BIT_FACTOR))
#define HALL1_CURRENT_HIGH_LIMIT_CHECK     ((uint16_t)(HALL1_CURRENT_BIT_OFFSET+CRITICAL_LIMIT_HALL_CURRENT/HALL1_CURRENT_BIT_FACTOR))

#define HALL2_CURRENT_LOW_LIMIT_CHECK      ((uint16_t)(HALL2_CURRENT_BIT_OFFSET-CRITICAL_LIMIT_HALL_CURRENT/HALL2_CURRENT_BIT_FACTOR))
#define HALL2_CURRENT_HIGH_LIMIT_CHECK     ((uint16_t)(HALL2_CURRENT_BIT_OFFSET+CRITICAL_LIMIT_HALL_CURRENT/HALL2_CURRENT_BIT_FACTOR))
...
//            teste = skiip2_current_adc_val;
    ...
    CPU1_CM_Message.I_COMP = (CLA2CPU_Message.I_COMP+10.0f)*10;
    CPU1_CM_Message.P_COMP = (CLA2CPU_Message.P_COMP+10.0f)*10;
