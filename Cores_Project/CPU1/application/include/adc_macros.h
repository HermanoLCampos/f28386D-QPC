...
#define HALL1_CURRENT_BIT_FACTOR   ((1000.0f*1.333f)*((3.0f/0.35f)/32768.0f))
#define HALL2_CURRENT_BIT_FACTOR   ((1000.0f*1.333f)*((3.0f/0.35f)/32768.0f))

#define SKIIP1_CURRENT_BIT_FACTOR  ((1000.0f/1.85f)*((3.0f/0.35f)/32768.0f))*(-1.0f)
