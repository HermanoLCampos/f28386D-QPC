//$file${.::Cores_Project::CPU1::qm_files::OCs::oc_ipc::oc_ipc.h} vvvvvvvvvvvv
//
// Model: main_model.qm
// File:  ${.::Cores_Project::CPU1::qm_files::OCs::oc_ipc::oc_ipc.h}
//
...
//
//$endhead${.::Cores_Project::CPU1::qm_files::OCs::oc_ipc::oc_ipc.h} ^^^^^^^^^
#ifndef OC_IPC_H_
#define OC_IPC_H_
