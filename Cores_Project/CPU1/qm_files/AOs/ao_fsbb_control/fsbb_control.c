...
QState FSBB_Control_Operation(FSBB_Control * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        case REPORT_STATUS_SIG: {
            ...
            report_message->msg.payload.state = me->state;
        ...
        case UPDATE_MEASURE_SIG: {
            ...
            case FSBB_MEASURE_SKIIP2_PCB_TEMPERATURE:
                ...
                CPU1_CM_Message.fsbb_temp_measures[evt_update_measure->data.measure_id] = me->measures[evt_update_measure->data.measure_id];
                break;
            default:
