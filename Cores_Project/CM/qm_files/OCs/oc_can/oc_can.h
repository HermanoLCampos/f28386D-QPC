//$file${.::Cores_Project::CM::qm_files::OCs::oc_can::oc_can.h} vvvvvvvvvvvvvv
//
// Model: main_model.qm
// File:  ${.::Cores_Project::CM::qm_files::OCs::oc_can::oc_can.h}
//
...
//
//$endhead${.::Cores_Project::CM::qm_files::OCs::oc_can::oc_can.h} ^^^^^^^^^^^
#ifndef OC_CAN_H_
#define OC_CAN_H_
